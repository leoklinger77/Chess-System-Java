...
public class ChessMatch {
	...
	private List<Piece> captredPieces = new ArrayList<>();
	...
	private Piece makeMove(Position source, Position target) {
		...
		if (capturedPiece != null) {
			...
			captredPieces.add(capturedPiece);
		}
		...
		// SpecialMove Castling Queengsite rook
		if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
	...
	private void unduMove(Position source, Position target, Piece capturedPiece) {
		...
		if (capturedPiece != null) {
			...
			captredPieces.remove(capturedPiece);
	...
	private void validateTargetPosition(Position saurce, Position target) {
		if (!board.piece(saurce).possibleMove(target)) {
